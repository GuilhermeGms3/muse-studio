...
export const Route = createFileRoute("/diagnostico")({
  head: () => ({ meta: [{ title: "Diagnostico inicial - Music OS" }] }),
          ...
          {step === 0 && (
            <>
              ...
              <fieldset className="mt-6">
                ...
                <div className="mt-2 grid gap-px bg-border md:grid-cols-3">
          ...
          {step === 3 && (
            <>
              ...
              <div className="mt-6 divide-y divide-border border-y border-border">
                {[
                  "Ainda estou aprendendo postura, notas ou acordes basicos.",
                  "Consigo tocar exercicios simples, mas perco o pulso.",
                  "Toco musicas faceis e controlo movimentos basicos.",
                  "Consigo estudar com metronomo e corrigir erros sozinho.",
                  "Tenho tecnica consistente e quero refinar musicalidade.",
                ].map((label, index) => (
                  <label
                    key={label}
