    ...
    static List<EditorialMissionDefinition> definitions() {
        return List.of(
                ...
                d("mission-keys-syncopation", LearningStage.BEGINNER_ADVANCED, "syncopation", "Acordes no contratempo, baixo no chão",
                        ...
                        "guided", 60, 88, 11, "Criar textura pop sincopada sobre quatro acordes.", Assessment.Type.PERFORMANCE,
                        List.of("ancora", "contratempo", "independencia"), List.of("thriller-keys")),
                ...
                d("mission-keys-transcription", LearningStage.UPPER_INTERMEDIATE, "transcription", "Separar baixo, voicing e ritmo pelo ouvido",
                        ...
                        "Trecho de Clocks reduzido; loop curto; registro de baixo, notas superiores e célula rítmica.",
                        ...
                        List.of("baixo", "voz-superior", "ritmo"), List.of("clocks-keys")),
