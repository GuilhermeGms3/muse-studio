    ...
    static List<EditorialMissionDefinition> definitions() {
        return List.of(
                ...
                d("mission-acoustic-quarter-strum", LearningStage.BEGINNER, "quarter-strumming", "Baixo no primeiro tempo, acorde nos demais",
                        ...
                        "context", 56, 80, 10, "Aplicar o padrão ao ciclo original C–G–Am–F por oito compassos.", Assessment.Type.APPLICATION,
                        List.of("baixo-correto", "pulso", "balanco-de-vozes"), List.of()),
                ...
                d("mission-acoustic-transcription", LearningStage.UPPER_INTERMEDIATE, "transcription", "Retirar baixo e levada de uma gravação",
                        ...
                        "Acompanhamento original Muse C–G–Am–F; áudio reduzido; papel para baixos, cifra e ritmo.",
                        ...
                        List.of("baixo", "harmonia", "levada"), List.of()),
